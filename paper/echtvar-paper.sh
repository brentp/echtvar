...
-out_names=[AC:gnomad_ac, AN:gnomad_an, nhomalt:gnomad_nhomalt, AF:gnomad_af,AC_popmax:gnomad_popmax_ac, AN_popmax:gnomad_popmax_an,nhomalt_popmax:gnomad_popmax_nhomalt_popmax, AF_popmax:gnomad_popmax_af,AF_controls_and_biobanks:gnomad_controls_and_biobanks_af,nhomalt_controls_and_biobanks:gnomad_controls_and_biobanks_nhomalt]
" > annoc
VARNOTE
